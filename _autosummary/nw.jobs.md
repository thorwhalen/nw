...
- **An estimate is re-quoted, never remembered.** When `params["plan"]` is
  ...
  [`nw.pricing.current_quote()`](nw.pricing.md#nw.pricing.current_quote) at today’s rates rather than trusting a
...
* **Parameters:**
  ...
  * **secrets** ([`Mapping`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Mapping)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`str`](https://docs.python.org/3/builtins/stdtypes.html#str)] | [`None`](https://docs.python.org/3/builtins/constants.html#None)) – the caller’s per-call credentials ([`nw.Secrets`](nw.md#nw.Secrets); any
    ...
    ([`nw.secrets.using_secrets()`](nw.secrets.md#nw.secrets.using_secrets)), innermost, so an explicit key
...
[`nw.pricing.current_quote()`](nw.pricing.md#nw.pricing.current_quote), and a caller-supplied
