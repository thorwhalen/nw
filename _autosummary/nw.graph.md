...
[`nw.freshness`](nw.freshness.md#module-nw.freshness); this module is where its input, the verifying trace, is
...
([`nw.transforms.FailedOutput`](nw.md#nw.FailedOutput)) — pass its `skeleton`,
...
it through [`nw.Project.resolved_genre()`](nw.md#nw.Project.resolved_genre), which returns the
