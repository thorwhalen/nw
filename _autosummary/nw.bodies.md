...
| [`character_ref`](nw.bodies.character_ref.md#module-nw.bodies.character_ref)         | Body schema for character refs — pointers to a character folder.     |
|-------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|
| [`decision`](nw.bodies.decision.md#module-nw.bodies.decision)                   | Body schema for decision-log entries.                                |
| [`environment_ref`](nw.bodies.environment_ref.md#module-nw.bodies.environment_ref)     | Body schema for environment refs.                                    |
| [`genre_envelope`](nw.bodies.genre_envelope.md#module-nw.bodies.genre_envelope)       | Body schema for the project's resolved genre envelope.               |
| [`render_result`](nw.bodies.render_result.md#module-nw.bodies.render_result)         | Body schema for render results — the output of a render Transform.   |
| [`section`](nw.bodies.section.md#module-nw.bodies.section)                     | Body schema for timeline sections (verse, chorus, scene-1, …).       |
| [`shot`](nw.bodies.shot.md#module-nw.bodies.shot)                           | Body schema for shots — the renderable visual unit.                  |
| [`unproduced_output`](nw.bodies.unproduced_output.md#module-nw.bodies.unproduced_output) | Body schema for unproduced-output records — nw#44.                   |
| [`verifying_trace`](nw.bodies.verifying_trace.md#module-nw.bodies.verifying_trace)     | Body schema for verifying traces — what makes early cutoff possible. |
