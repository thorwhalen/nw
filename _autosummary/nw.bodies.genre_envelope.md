...
precedent ([`nw.bodies.decision`](nw.bodies.decision.md#module-nw.bodies.decision) — a timeless, project-local, typed
...
[`nw.genres.Template`](nw.md#nw.Template): the app that owns the genre gives it meaning.
