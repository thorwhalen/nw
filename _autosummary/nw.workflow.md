...
[`nw.renderers`](nw.renderers.md#module-nw.renderers) are the *shot* render unit: they bake in
[`nw.schema.ShotSpec`](nw.schema.md#nw.schema.ShotSpec), an open-string `render_strategy`, and an
...
[`nw.transforms`](nw.transforms.md#nw.transforms), whose `plan`/`execute` split is the same shape over
...
call [`nw.renderers.get_strategy()`](nw.renderers.md#nw.renderers.get_strategy). So a “cleanup” here — dropping
...
[`execute_render()`](#nw.workflow.execute_render) and [`nw.renderers.get_strategy()`](nw.renderers.md#nw.renderers.get_strategy) have **zero** call
