...
queries, and view rendering. The backend is chosen by [`nw.graph_backend`](nw.graph_backend.md#module-nw.graph_backend)
...
`NW_GRAPH_BACKEND=postgres`) is resolved by [`nw.graph_backend`](nw.graph_backend.md#module-nw.graph_backend) — the
